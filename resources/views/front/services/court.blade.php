        ...
        <div class="row">
            <div class="col-xl-5">
                <div class="project-description-image-box">
                    <img src="images/resources/bond.jpg" alt="Awesome Image">
                </div>
            </div>
            <div class="col-xl-7">
                <div class="project-description-content">
                    ...
                    <div class="inner-content">
                        ...
                        <div class="bottpm-text">
                            ...
                            <p>We are committed to offering comprehensive and reliable court bail services tailored to meet the needs of our clients across Kenya. We understand the complexities and challenges that
                                can arise during legal proceedings, which is why we provide expert guidance and support at every step of the bail process. Our services include the provision of sureties and the arrangement
                                of collateral, ensuring that you have the necessary guarantees to secure bail quickly and efficiently. With a deep understanding of the Kenyan legal system, our experienced team works
                                tirelessly to provide solutions that bring you peace of mind when you need it most. Whether you're dealing with a minor legal matter or a more complex situation, Sampesa Group Ltd is here
                                to support you with professionalism, integrity, and a commitment to your rights.</p>
