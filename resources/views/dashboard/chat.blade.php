        ...
        <div class="accordion-item">
          <div class="row ">
            ...
            <div class="col-3 bg-light" id="">
              <div class="">
                ...
                <div class="scrollable">
                  ...
                  <div class="row m-2 d-flex justify-content-between" id="heading{{$k}}" type="button" data-toggle="collapse" data-target="#collapse{{$k}}" aria-expanded="true" aria-controls="collapse{{$k}}">
            ...
            <div class="col-9 card" id='chat-box'>
              @foreach($users as $k=>$user)
              <div id="collapse{{$k}}" class="accordion-collapse collapse {{$k==0?'show':''}}" aria-labelledby="heading{{$k}}" data-parent="#accordionExample">
                  ...
                  <div class="h-100">
                    <div class="w-100">
                      ...
                      <div class="row  py-2 px-3 bg-white d-flex justify-content-between">
                        ...
                        <div class="col-4">
                          <h6 class="lh-1 mB-0">{{$user->fname}}</h6>
                          @if($user->isOnline())
                    ...
                    <div class="layer w-100">
                      <form action="{{route('chat.store',['userId'=>($user->id)])}}" method="post">
                        @csrf
