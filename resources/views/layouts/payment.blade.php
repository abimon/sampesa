@extends('layouts.app',['title'=>'Paypal Payment'])
@section('content')
<?php
	...
	class OAuthSignatureMethod_RSA_SHA1 extends OAuthSignatureMethod {
	  ...
	  protected function fetch_public_cert(&$request) {
        ...
        try {
            ...
            return "fetch_public_cert not implemented";
        }
	  }
	  ...
	  protected function fetch_private_cert(&$request) {
        ...
        try {
            ...
            return "fetch_private_cert not implemented";
        }
	  }
...
$consumer_key = 'bzRd2be82tiRTRS7TmmQmxUJj982J+Le';//Register a merchant account on
//demo.pesapal.com and use the merchant key for testing.
//When you are ready to go live make sure you change the key to the live account
//registered on www.pesapal.com!
$consumer_secret = 'yGUdLtM8ece/YNsq/ANjt+4OVaY=';// Use the secret from your test
...
$callback_url = 'http://www.sampesagroup.com/fdr/modules/client/payment_status.php'; //redirect url, the page that will handle the response from pesapal.
